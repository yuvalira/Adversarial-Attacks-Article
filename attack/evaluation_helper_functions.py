...
def plot_roc_comparison(figures_path, model_name, df_attacked, label_col='original_label', original_score_col='original_score', attacked_score_col='attacked_score'):
    # Extract true labels
    ...
    file_path = os.path.join(figures_path, model_name+'_ROC_plot')
