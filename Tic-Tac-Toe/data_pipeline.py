...
# 1. Parameters
# ----------------------------
KAGGLE_ID = "fabdelja/tictactoe"
LABEL_COL = "CLASS"
POS_LABEL = "draw"
HF_REPO_ID = "yuvalira/Tic-Tac-Toe_balanced"
SEED = 42
...
if "MOVE6" in df.columns:
    df = df.drop(columns=["MOVE6"])
if "MOVE7" in df.columns:
    df = df.drop(columns=["MOVE7"])
